/**
 * countrySeoConfig.js (Server CommonJS)
 * International & Foreigner SEO Matrix for Global Jobs Portal Server-Side Injection.
 */

const SOVEREIGN_COUNTRIES = require('./data/sovereignCountries195.json');

const COUNTRY_MAP = new Map();
SOVEREIGN_COUNTRIES.forEach(c => {
  COUNTRY_MAP.set(c.code.toUpperCase(), c);
});

const COUNTRY_SEO_CONFIG = {
  US: {
    lang: 'en-US',
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=US',
  ...
  DE: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=DE',
  ...
  FR: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=FR',
  ...
  ES: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=ES',
  ...
  SG: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=SG',
  ...
  GB: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=GB',
  ...
  CA: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=CA',
  ...
  AU: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=AU',
  ...
  IN: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=IN',
  ...
  AE: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=AE',
  ...
  SA: {
    ...
    canonical: 'https://www.digitalhomeblog.in/global-jobs?country=SA',
...
function getCountrySeoMeta(countryCode) {
  ...
  if (COUNTRY_SEO_CONFIG[upper]) {
    return {
      ...
      canonical: `https://www.digitalhomeblog.in/global-jobs?country=${upper}`
    };
  }

  const countryInfo = COUNTRY_MAP.get(upper);
...
function buildHreflangMatrix(activeCountryCode) {
  const baseUrl = 'https://www.digitalhomeblog.in';
  
  const matrix = [
    { lang: 'x-default', href: `${baseUrl}/global-jobs` },
    { lang: 'en-US', href: `${baseUrl}/global-jobs?country=US` },
    { lang: 'en-GB', href: `${baseUrl}/global-jobs?country=GB` },
    { lang: 'en-CA', href: `${baseUrl}/global-jobs?country=CA` },
    { lang: 'en-AU', href: `${baseUrl}/global-jobs?country=AU` },
    { lang: 'de-DE', href: `${baseUrl}/global-jobs?country=DE` },
    { lang: 'fr-FR', href: `${baseUrl}/global-jobs?country=FR` },
    { lang: 'es-ES', href: `${baseUrl}/global-jobs?country=ES` },
    { lang: 'en-SG', href: `${baseUrl}/global-jobs?country=SG` },
    { lang: 'en-IN', href: `${baseUrl}/global-jobs?country=IN` },
    { lang: 'ar-AE', href: `${baseUrl}/global-jobs?country=AE` },
    { lang: 'ar-SA', href: `${baseUrl}/global-jobs?country=SA` }
  ];
  ...
  if (activeCountryCode && activeCountryCode !== 'ALL') {
    ...
    const targetHref = `${baseUrl}/global-jobs?country=${upper}`;
