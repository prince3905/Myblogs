    ...
    >
      ...
      <DialogContent sx={{ textAlign: 'center', pb: 2 }}>
        <Typography variant="body2" sx={{ color: '#4b5563', mb: 2.5, px: 1, lineHeight: 1.6 }}>
          सरकारी भर्ती, एडमिट कार्ड और रिजल्ट्स की पल-पल की जानकारी सबसे पहले पाने के लिए हमारे व्हाट्सएप & टेलीग्राम चैनल को जॉइन करें!
        </Typography>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, mb: 3 }}>
          ...
          >
            Join WhatsApp Channel (फ्री अपडेट्स)
          </Button>
